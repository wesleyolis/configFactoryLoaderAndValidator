...
export const Factory = <I extends IConfigFactory, F extends FactoryType> (type : F) =>
{
  const factories = Joi.alternatives() as any;
  factories['__isFactory'] = type; 

  return factories as (XAlternativesSchema & {__Factory: I})
}
...
export type XSchema = {__tsType: any, __isRequired?: 'T', __isNullable?: 'T', __isFactory: undefined} & _XSchema;
